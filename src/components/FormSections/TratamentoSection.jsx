            ...
            <TreatmentSubSection>
                ...
                {formData.tratamento.core_biopsy?.realizada && (
                    <FormGrid style={{ marginTop: '1.5rem' }}>
                        ...
                        {(formData.tratamento.core_biopsy.anatomopatologico === 'malignidade' || formData.tratamento.core_biopsy.anatomopatologico === 'ausencia_malignidade') && <FieldContainer style={{ gridColumn: 'span 3' }}><InputLabel>Tipo Histológico</InputLabel><StyledInput name="tipo_histologico" value={formData.tratamento.core_biopsy.tipo_histologico || ''} onChange={(e) => handleSimpleChange(e, 'tratamento.core_biopsy')} /></FieldContainer>}
                    </FormGrid>
                )}
            </TreatmentSubSection>
            ...
            <TreatmentSubSection>
                ...
                {formData.tratamento.mamotomia?.realizada && (
                    <FormGrid style={{ marginTop: '1.5rem' }}>
                        ...
                        {(formData.tratamento.mamotomia.anatomopatologico === 'malignidade' || formData.tratamento.mamotomia.anatomopatologico === 'ausencia_malignidade') && <FieldContainer style={{ gridColumn: 'span 3' }}><InputLabel>Tipo Histológico</InputLabel><StyledInput name="tipo_histologico" value={formData.tratamento.mamotomia.tipo_histologico || ''} onChange={(e) => handleSimpleChange(e, 'tratamento.mamotomia')} /></FieldContainer>}
                    </FormGrid>
                )}
            </TreatmentSubSection>
